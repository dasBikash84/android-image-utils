...
public class ImageCompressionUtils {
    ...
    public static Bitmap getBitmapImageFromUri(Context context, Uri selectedImage) {
        Bitmap bm = null;
    ...
    public static Bitmap getBitmapImageFromFile(Context context, File file) {
        Bitmap bm = null;
    ...
    private static Bitmap getImageResized(Context context, Uri selectedImage) {
        Bitmap bm = null;
        int[] sampleSizes = new int[]{11,9,7,5, 3, 2, 1};
        int i = 0;
        do {
